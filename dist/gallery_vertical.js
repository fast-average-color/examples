(function (factory) {
    ...
    function getVerticalColors(img) {
        var result = [];
    ...
    function getHorizontalColors(img) {
        var result = [];
    ...
    function getVerticalGradient(data) {
        return "linear-gradient(180deg, ".concat(data.join(', '), ")");
    }
    function getHorizontalGradient(data) {
        return "linear-gradient(90deg, ".concat(data.join(', '), ")");
    }

    window.addEventListener('load', function () {
        var items = Array.from(document.querySelectorAll('.slider__item'));
        var bigImage = document.querySelector('.big-image');
        var verticalGradient = document.querySelector('.vertical-gradient');
        var horizontalGradient = document.querySelector('.horizontal-gradient');
        ...
        function onClick(elem) {
            ...
            bigImage.onload = function () {
                var verticalColors = getVerticalColors(bigImage);
                var horizontalColors = getHorizontalColors(bigImage);
